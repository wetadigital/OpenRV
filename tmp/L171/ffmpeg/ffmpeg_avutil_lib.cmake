...
foreach(_cmake_expected_target IN ITEMS ffmpeg::avutil)
...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  file(GLOB
    _FFMPEG_HEADERS
    "/vol/apps/ffmpeg/7.1.0-weta.1/gcc-171/libavutil/*.h"
  )
  target_sources(ffmpeg::avutil
    INTERFACE
      FILE_SET "HEADERS"
      TYPE "HEADERS"
...
# Import target "ffmpeg::avutil" for configuration ""
set_property(TARGET ffmpeg::avutil APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(ffmpeg::avutil PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "CXX"
  IMPORTED_LOCATION_NOCONFIG "/vol/apps/ffmpeg/7.1.0-weta.1/gcc-171/lib/libavutil.so"
  )
