...
foreach(_cmake_expected_target IN ITEMS ffmpeg::avcodec)
...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  file(GLOB
    _FFMPEG_HEADERS
    "/vol/apps/ffmpeg/7.1.0-weta.1/gcc-171/libavcodec/*.h"
  )
  target_sources(ffmpeg::avcodec
    INTERFACE
      FILE_SET "HEADERS"
      TYPE "HEADERS"
...
# Import target "ffmpeg::avcodec" for configuration ""
set_property(TARGET ffmpeg::avcodec APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(ffmpeg::avcodec PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "CXX"
  IMPORTED_LOCATION_NOCONFIG "/vol/apps/ffmpeg/7.1.0-weta.1/gcc-171/lib/libavcodec.so"
  )
